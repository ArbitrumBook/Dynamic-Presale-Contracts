...
contract ArbitrumBookDynamicPresale is Ownable {
    ...
    uint256 public constant MAX_DEPOSIT_QUEUE = 500 * 10 ** 6;
    ...
    function removeUsers(address[] memory _users) public {
        for (uint256 i = 0; i < _users.length; i++) {
    ...
    function bootstrapTreasury(address _treasury) public onlyOwner {
        uint256 amount = USDC.balanceOf(address(this));
        SafeERC20.safeTransfer(USDC, _treasury, amount);
    }
